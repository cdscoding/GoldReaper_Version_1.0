...
function MainWindow:OnInitialize()
    ...
    MainWindow.frame.TitleText:SetText("GoldReaper - v1.0.2")
    ...
    local supportButton = CreateFrame("Button", nil, sidebar, "UIPanelButtonTemplate"); supportButton:SetSize(180, 25); supportButton:SetPoint("TOPLEFT", infoButton, "BOTTOMLEFT", 0, -5); supportButton:SetText("Support & Community"); supportButton:SetScript("OnClick", function() addon:ToggleWelcomeWindow() end)
